...
@section('content')
    <p class="h4 mb-4 fw-bold">Cuti Pegawai</p>
    ...
    {{-- TABEL DATA CUTI PEGAWAI --}}
    <div class="card shadow-sm">
        <div class="card-header bg-white border-bottom">
            <div class="d-flex justify-content-end align-items-center">
                {{-- Tombol Lihat Detail dipindahkan ke sini --}}
                <a href="{{ url('/cuti/create') }}" style="text-decoration: none;">
                    <button class="btn btn-sm fw-bold text-dark d-flex align-items-center px-4 py-2"
                        style="background-color: #86efac; border-color: #86efac; border-radius: 8px;">
                        Lihat Detail
                    </button>
                </a>
            </div>
                ...
                <table class="table table-hover align-middle mb-0">
                    <thead style="background-color: #6b7280; color: white;">
                        <tr>
                            ...
                            <th class="py-3">Identitas Pegawai/Karyawan</th>
                            <th class="py-3">Tanggal Permohonan</th>
                            <th class="py-3 text-center">Lama Cuti</th>
                            <th class="py-3 text-center">Kuota Tersisa</th>
                            <th class="py-3">Upload Permohonan Cuti</th>
                    ...
                    <tbody>
                        <tr style="background-color: #f9fafb;">
                            ...
                            <td>13-02-2025 sd<br>14-02-2025</td>
                            <td class="text-center">2 Hari</td>
                            <td class="text-center">10 Hari</td>
                            <td>
                                <a href="#" class="text-decoration-underline text-dark">Surat_Cuti.pdf</a>
                            </td>
                        ...
                        <tr style="background-color: #f9fafb;">
                            ...
                            <td>14-02-2025 sd<br>16-02-2025</td>
                            <td class="text-center">3 Hari</td>
                        ...
                        <tr style="background-color: #f9fafb;">
                            ...
                            <td>12-02-2025 sd<br>13-02-2025</td>
                            <td class="text-center">2 Hari</td>
