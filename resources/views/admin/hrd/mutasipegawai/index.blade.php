...
@section('content')
    <div class="container-fluid p-3">
        ...
        <h5 class="card-title text-dark" style="font-size: 0.875rem; font-weight: bold; margin-bottom: 20px;">Silahkan Cari
            Data Yang Anda Butuhkan</h5>

        <div class="row mb-1">
            {{-- Form Pencarian Unit Kerja --}}
            <div class="col-lg-6 col-md-12">
                <div class="form-group row align-items-center">
                    <label for="unitKerja" class="col-sm-3 col-form-label text-sm-right" style="padding-right: 5px;">Unit
                        Kerja/Divisi :</label>
                    <div class="col-sm-9">
                        <div class="input-group custom-input-group">
                            <input type="text" class="form-control" id="unitKerja" value=": Semua Unit Kerja / Divisi"
                                readonly>
                            <div class="input-group-append">
                                <button class="btn btn-sm btn-outline-secondary" type="button"
                                    style="background-color: #e9ecef; border-color: #ced4da; color: #6c757d; border-radius: 0;">
                                    <i class="fas fa-search"></i>
                                </button>
                            </div>
                            <div class="input-group-append">
                                <button class="btn btn-sm btn-light" type="button"
                                    style="background-color: #e9ecef; border-color: #6c757d; color: #6c757d; border-radius: 0 5px 5px 0;">
                                    Pilih
                                </button>
                            </div>
                        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-lg-6 col-md-12">
                <div class="form-group row align-items-center">
                    <label for="namaKaryawan" class="col-sm-3 col-form-label text-sm-right" style="padding-right: 5px;">Nama
                        Karyawan :</label>
                    <div class="col-sm-9">
                        <div class="input-group custom-input-group">
                            <input type="text" class="form-control" id="namaKaryawan"
                                value="Tri Admajo Surya /1928019289901">
                            <div class="input-group-append">
                                <button class="btn btn-sm btn-outline-secondary" type="button"
                                    style="background-color: #e9ecef; border-color: #ced4da; color: #6c757d; border-radius: 0;">
                                    <i class="fas fa-search"></i>
        ...
        <div class="row justify-content-end mb-3">
            <div class="col-auto">
                <button class="btn btn-sm text-white mr-2"
                    style="background-color: #8ce9e9; border: 1px solid #79d8d1; border-radius: 5px; font-weight: bold; padding: 5px 15px;">
                    Entry
                </button>
                <button class="btn btn-sm text-dark"
                    style="background-color: #a4f4a4; border: 1px solid #a4f4a4; border-radius: 5px; font-weight: bold; padding: 5px 15px;">
                    Cetak
                </button>
            </div>
        </div>
                    ...
                    <tr>
                        ...
                        <td class="text-center align-middle">
                            <button class="btn btn-sm text-white"
                                style="background-color: #76ff76; border: none; font-weight: bold; padding: 5px 15px;">
                                Lihat
                            </button>
                        </td>
                    </tr>
