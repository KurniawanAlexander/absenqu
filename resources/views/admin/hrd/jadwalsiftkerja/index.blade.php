...
@section('content')
    <p class="h4 mb-4 fw-bold">Jadwal Shift Kerja Pegawai</p>
>>>>>>> 982c53b39d13611a0149539e5f749411af15554d
                    ...
                    <div class="row">
                        ...
                        <div>
                            <div class="d-flex align-items-center mb-2 pb-2">
                                ...
                                {{-- KOLOM 3: INPUT / SELECT + TOMBOL DEMPET --}}
                            ...
                            <div class="d-flex align-items-center mb-2 pb-2">
                                ...
                                {{-- KOLOM 1: LABEL (Rata Kanan) --}}
                                <div style="min-width: 140px;" class="text-start">
                                    <label class="mb-0 d-inline-block">Nama Karyawan</label>
                                </div>
                            ...
                            <div class="d-flex align-items-center mb-2 pb-2">
                                ...
                                {{-- KOLOM 1: LABEL (Rata Kanan) --}}
                                <div style="min-width: 140px;" class="text-start">
                                    <label class="mb-0 d-inline-block">Periode</label>
                                </div>
                                ...
                                <div class="d-flex align-items-center">
                                    <input type="date" class="form-control form-control-sm me-2" style="width: 120px;"
                                        value="2025-02-12">
                                    <span class="fw-bold me-2">sd</span>

                                    {{-- Input Group untuk Tanggal Akhir --}}
                                    <div class="input-group">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0 card-no-border">
                        <h4>Keytable Integration</h4><span>If you are looking to emulate the UI of spreadsheet programs such
                            as
                            Excel with DataTables, the combination of KeyTable and AutoFill will take you a long way
                            there!</span>
                    </div>
                    <div class="card-body">
