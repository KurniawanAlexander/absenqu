  <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      ...
      <style>
          /* Target the HTML <nav> element with class fixed-top or elements with .navbar.fixed-top
             instead of the generic .nav.fixed-top which is often used by sidebar lists. */
          nav.fixed-top,
          .navbar.fixed-top {
              background-color: #34FFF1 !important;
          }
      </style>
  </nav>
